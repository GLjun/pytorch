#!/bin/bash
python wa_sgd_opt_outplace.py --classes 10 -b 512 --ave-weight --lr 0.01 --sgd SGDOPO_MW --momentum 0.0
...
python main.py -a vgg16 --multiprocessing-distributed --world-size 1 --rank 0 -b 512 --workers 16 --lr 0.01 --classes 10 --momentum 0.0 /home/gw/data/imagenet_10
