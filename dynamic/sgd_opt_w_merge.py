...
class SGDOPO_MW(Optimizer):
    ...
    def __init__(self, model, gpu=-1, lr=0.1, momentum=0, dampening=0,
        ...
        super(SGDOPO_MW, self).__init__(model.parameters(), defaults)
        ...
        self.cnt = 0
        self.gpu = gpu
        print("SGDOPO_MW alpha %f", self.alpha)
        ...
        for m in module_list:
            ...
            for key, param in m.named_parameters():
                if param.data is not None and param.requires_grad:
                    ...
                    m.register_buffer(self.prefix+key, buf)
